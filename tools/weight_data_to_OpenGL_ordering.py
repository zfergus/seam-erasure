#!/usr/bin/env python
""" Convert data in Image row ordering to OpenGL ordering. """
...
def weight_data_to_OpenGL_ordering(data):
    """ Convert data in Image row ordering to OpenGL ordering. """
    return data[::-1]
...
if __name__ == "__main__":
    ...
    weight_data.write_tex_to_path(
        weight_data_to_OpenGL_ordering(read_tex_from_path(in_path)), out_path)
